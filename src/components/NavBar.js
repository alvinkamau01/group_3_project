  ...
  return (
    <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 5px rgba(0, 0, 0, 0.1)' }}>
      <div className="container-fluid" style={{ padding: "20px" }}>
        <a className="navbar-brand" href="#" style={{ color: '#333333' }}>
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav ms-auto">
            ...
            <Link className="nav-link" to="/features" style={{ color: '#333333' }}>
              <i className="bi bi-star" style={{ marginRight: '5px' }}></i> Features
            </Link>
            <Link className="nav-link" to="/pricing" style={{ color: '#333333' }}>
              <i className="bi bi-cash" style={{ marginRight: '5px' }}></i> Pricing
            </Link>
            <Link className="nav-link disabled" aria-disabled="true" to="#" style={{ color: '#cccccc' }}>
